...
import { fetchOpportunities, fetchOpportunityById } from './utils/api';
...
function App() {
  ...
  const handleViewDetails = async (id) => {
    ...
    try {
      ...
      alert('Failed to load opportunity placement details. Please check connection and try again.');
    } finally {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      ...
      {/* Global Page loading indicator on modal trigger */}
      {modalLoading && (
        <div id="modal-spinner-overlay" className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/10 backdrop-blur-[2px]">
