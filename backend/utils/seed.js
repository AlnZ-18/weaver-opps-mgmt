...
const seedAdmin = async () => {
  try {
    ...
    const adminEmail = 'admin.amaravati@aiesec.net';
    const adminPassword = 'AdminPassword123!'; // Passwords will be automatically encrypted by pre-save schema hooks
